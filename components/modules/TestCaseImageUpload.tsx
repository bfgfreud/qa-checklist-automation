...
export const TestCaseImageUpload: React.FC<TestCaseImageUploadProps> = ({
  ...
  const uploadFile = async (file: File) => {
    ...
    try {
      ...
      // Use testcase-specific endpoint if editing, generic endpoint for new testcases
      const endpoint = testCaseId
        ? `/api/testcases/${testCaseId}/image`
        : '/api/custom-testcase-images';
  ...
  // Full mode for forms - works for both new and existing test cases
  return (
    <div className="mb-4">
